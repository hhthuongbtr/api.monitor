...
urlpatterns = [
    ...
    url(r'^(?P<region>\w+)/monitor/$', views.MonitorList().routing),

    url(r'^running/$', views.MonitorList().get_running_monitor_list),
    url(r'^(?P<region>\w+)/running/$', views.MonitorList().get_running_monitor_list),

    url(r'^waiting/$', views.MonitorList().get_waiting_monitor_list),
    url(r'^(?P<region>\w+)/waiting/$', views.MonitorList().get_waiting_monitor_list),
